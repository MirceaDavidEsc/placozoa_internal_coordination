...
filteredVideos = read_csv(paste(projectFolder,"/Data_Processed/curatedFolders.csv", sep = ""))
uncurledOrderSummary_filtered = inner_join(uncurledOrderSummary, filteredVideos, by = c("folder" = "goodFolders"))
write_rds(uncurledOrderSummary_filtered, paste(projectFolder, processedDataFolder,"relevantOrderData_filtered.rds", sep = "/"))
