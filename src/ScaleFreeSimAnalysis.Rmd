...
simulationTypes = data.frame(simType = c("_fluid", "_fixed", "_fluid_fast"), folderName = c("Simdata_Szabo_new_out", "SimData", "SimData_Szabo_fast_out"),
                             criticalMin = c(1.4, 1.3, 1.4), criticalMax = c(1.8, 1.6, 1.8), criticalLevel = c(1.6, 1.5, 1.6))
...
selectedFrame = unique(criticalityFrames$Frame[[1]]) # Arbitrarily selected frame
