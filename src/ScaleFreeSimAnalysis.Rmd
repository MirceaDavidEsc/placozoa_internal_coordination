...
cl = cl %>% cluster_library("scalefree") %>% cluster_library("dplyr") %>% cluster_library("purrr") %>% 
  cluster_library("tidyr") %>% cluster_library("stringr") %>% cluster_library("readr") %>% cluster_library("collective") %>%
  cluster_library("bigsplines") %>% cluster_library("alphahull")
